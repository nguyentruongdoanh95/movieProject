...
class ContentCell: BaseCellCollection {
    
    func getForCell(data: Movie) {
        nameFilm.text = data.title // Tên movies
    ...
    var nameFilmLabelHeightContraint: NSLayoutConstraint? // Thay đổi
